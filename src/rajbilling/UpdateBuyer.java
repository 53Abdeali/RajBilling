...
public class UpdateBuyer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Update_Buyer.png"))); // NOI18N
...
//            ub.setLocationRelativeTo(null);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
           Connection con = ConnectionProvider.getcon();
           Statement st = con.createStatement();
           st.executeUpdate("Update buyer Set name='"+name+"',contactNo='"+ContactNo+"',email='"+email+"',address='"+address+"'where contactNo='"+contactNo+"'");
